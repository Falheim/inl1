...
typedef struct action
{
  ...
  int s_index; // used for storing index when edit/ remove, even thou user may use index for other things.
  Good copy; 
}action_t;
...
int edit_good(Good *g);      //return cancel int
int listing_action(DB_t *d, int page, action_t *a); // return cancel int
...
//DB
void add_to_db(DB_t *head, Good g); // add to end
